    ...
    for dataloader_count, dataloaders in enumerate(list_of_dataloaders):
        ...
        for i, SimpleNet in enumerate(simplenet_list):
            ...
            if not test:
                ...
                i_auroc, p_auroc = SimpleNet.test(
                    dataloaders["training"], dataloaders["testing"], save_segmentation_images
                )
                pro_auroc = -1
...
@click.option("--lambda_bce", type=float, default=0.1, show_default=True)
def net(
    backbone_names,
